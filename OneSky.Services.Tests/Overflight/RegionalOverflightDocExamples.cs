...
namespace OneSky.Services.Tests.Overflight
{
    ...
    public class RegionalOverflightDocExamples
    {
        ...
        public void IssOverflight()
        {
            ...
            var expected = JsonConvert.DeserializeObject<List<OverflightAccessResult<ServiceCartesianWithTime>>>(TestHelper.RegionalOverflightDocExample);
